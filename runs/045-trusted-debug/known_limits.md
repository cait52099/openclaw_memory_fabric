# OCMF Phase 045 Known Limits - Trusted Journey Debug
...
- ✓ Claude install determinism (5x verified)
- ✓ Trusted journey scenario (5x verified)
...
| File | Purpose |
|------|---------|
| `runs/045-trusted-debug/trusted_journey_debug.md` | Debug trace results |
| `runs/045-trusted-debug/install_debug_trace.md` | Install verification trace |
| `runs/045-trusted-debug/friction_log.md` | Friction points |
| `runs/045-trusted-debug/evidence.md` | Phase evidence summary |
| `runs/045-trusted-debug/known_limits.md` | This file |
