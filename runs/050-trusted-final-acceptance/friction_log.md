...
| Issue | Was | Now |
|-------|-----|-----|
| Claude identity drift | REPORTED_BLOCKER | FIXED in current env |
| Switching identity drift | REPORTED_BLOCKER | FIXED in current env |
| Clean-home first-use | BLOCKER | FIXED in current env |
| Config syntax error | REPORTED_BLOCKER | FIXED in current env |
